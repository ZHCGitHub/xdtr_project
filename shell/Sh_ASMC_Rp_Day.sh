...
python ${xdtr_ASMC_python_dir}/Py_ASMC_Insert_TB_BS_RP_PLAT_NUMBER_DAY.py ${date}

#echo "*************************Running: Py_ASMC_Insert_TB_BS_RP_MOD_NUMBER_DAY.py*************************" >> $log 
python ${xdtr_ASMC_python_dir}/Py_ASMC_Insert_TB_BS_RP_MOD_NUMBER_DAY.py ${date}

#echo "*************************Running: Py_ASMC_Insert_TB_BS_RP_SYS_PHOTO_DAY.py*************************" >> $log 
python ${xdtr_ASMC_python_dir}/Py_ASMC_Insert_TB_BS_RP_SYS_PHOTO_DAY.py ${date}

#echo "*************************Running: Py_ASMC_Insert_TB_BS_RP_SYS_RISK_NUMBER_DAY.py*************************" >> $log 
python ${xdtr_ASMC_python_dir}/Py_ASMC_Insert_TB_BS_RP_SYS_RISK_NUMBER_DAY.py ${date}

#echo "*************************Running: Sh_ASMC_Sqoop_RP_DAY.sh*************************" >> $log
